...
/**
 * Read-only live terminal: streams the output of a command the agent executed
 * through a termux-mcp server. Opened from a tool result; streams over the
 * native SSE client until the task finishes.
 *
 * Author: AjiroDesu
 */
